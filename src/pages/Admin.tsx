          ...
          <Card>
            <CardHeader>
              <div className="flex items-center gap-2">
                ...
                <CardTitle>NutriSaver API Configuration</CardTitle>
              </div>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground mb-6">
                Configure your Spoonacular API key here. Once set, all users of the application will be able to fetch
                real recipe data without needing to configure their own API keys.
              </p>
